...
Svelte 5 + SvelteKit 2 example application demonstrating all 236 components from the [Lily Design System](https://github.com/LilyDesignSystem/lily) headless component library, styled with [NHS UK design system](https://service-manual.nhs.uk/design-system) colors, typography, spacing, and focus states.
...
- [Svelte Headless](../lily-svelte-headless/) — 236 headless Svelte components
