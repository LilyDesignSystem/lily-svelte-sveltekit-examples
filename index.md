...
Svelte 5 + SvelteKit 2 example application demonstrating all 284 components from the [Lily Design System](https://github.com/LilyDesignSystem/lily) headless component library, styled with [NHS UK design system](https://service-manual.nhs.uk/design-system) colors, typography, spacing, and focus states.

## Features

- 284 headless Svelte 5 components with runes
...
│   └── lib/
│       └── components/         # 284 headless Svelte components
├── static/
...
- **Component styles**: All 284 component CSS classes with NHS-appropriate styling
...
- [Svelte Headless](../lily-svelte-headless/) — 284 headless Svelte components
